...
import { Play, Users, Video, Youtube, Sparkles } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 pt-12 pb-32 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <AnimatedSection delay={0.3} variant="fadeUp">
            <p className="text-lg md:text-xl text-[var(--color-text-secondary)] mb-10 max-w-xl mx-auto leading-relaxed">
          ...
          <AnimatedSection delay={0.5} variant="fadeIn">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 mt-12 pt-8 border-t border-[var(--color-border)]">
